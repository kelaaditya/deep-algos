...
def mlp_nesterov_l2(X_tr, y_tr, X_t, y_t, epochs, batch_size):
    X = T.tensor4('X')
    y = T.ivector('y')
    ...
    l2_regularization = lasagne.regularization.regularize_layer_params(output_layer, lasagne.regularization.l2)
...
if __name__ == "__main__":
    training_loss, test_accuracy = mlp_nesterov_l2(X_train, y_train, X_test, y_test, 2, 500)
